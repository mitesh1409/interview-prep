...
Use `const` for variables whose value should **never** change. This does **not** mean the value is immutable, only that the variable **binding** cannot be re-assigned.
