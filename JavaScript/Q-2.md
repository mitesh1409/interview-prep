...
* outerFunction's Lexical Environment has a reference to the Global Lexical Environment.  
...
> 
> * An Environment Record (current scope bindings)
> * A reference to an outer Lexical Environment
> 
> This forms a linked chain that ends at the Global Lexical Environment.
