...
Both Browser & Node.js are JavaScript Runtime environments with different capabilities.
...
These modules/objects are available in Node.js only, they are not there in the Browser.
