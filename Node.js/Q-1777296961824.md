...
3. **Avoid Global Variables**  
   Minimize the use of global variables, as they persist for the lifetime of the application and can lead to unintended memory retention. They are never eligible for garbage collection.
...
5. **Avoid Closures that Retain References**  
...
7. **Properly Manage Event Listeners**  
