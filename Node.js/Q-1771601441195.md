...
mostly it will contain some asynchronous code (that is why we are writing a Promise).
...
the driver arrives to your location, picks you up, starts a ride,  
finally you reach to your destination,  
your ride request has been resolved/fulfilled.

Promise is in "Resolved"/"Fulfilled" state.

But in some cases, the driver might reject your ride or vehicle might break-down in the middle etc.  
