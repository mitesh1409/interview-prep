# How would you handle multiple asynchronous calls efficiently? OR Promises parallel, sequence & race execution
...
Returns the result of resolved promises as an array.  
...
Example: Sequential execution of promises using async/await.  
...
const sequentialPromisesOutput = await sequentialPromises();
console.log('await sequentialPromises() output >>', sequentialPromisesOutput);
...
When using Sequential, all promises will execute one after the other,  
