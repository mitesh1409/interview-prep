...
26. [What happens when you call `require()` multiple times for the same module OR import the same module multiple times?](./Q-1778573784076.md)
27. [How does Node.js handles asynchronous operations? OR Callbacks, Promises, async-await in Node.js](./Q-1771585486291.md)
28. [How do you handle errors in asynchronous code? Provide examples.](./Q-1771601217168.md)
29. [Coding Question](./Q-1771601261333.md)
30. [How would you handle multiple asynchronous calls efficiently? OR Promises parallel, sequence & race execution](./Q-1771601292399.md)
31. [Simple HTTP Server using Node.js Only](./Q-1771601388409.md)
32. [Promises in Node.js](./Q-1771601441195.md)
33. [What happens if an unhandled promise rejection occurs? OR The purpose of using global error handlers like `process.on('unhandledRejection')`](./Q-1771601666435.md)
34. [What happens if an uncaught exception occurs? OR The purpose of using global error handlers like `process.on('uncaughtException')`](./Q-1772174646207.md)
35. [Middleware in Express.js](./Q-1772178692962.md)
36. [What are Streams in Node.js?](./Q-1772178705973.md)
37. [How can you secure a Node.js application?](./Q-1777296324889.md)
38. [What is Buffer in Node.js?](./Q-1777296381727.md)
39. [How do you handle large file uploads efficiently in Node.js?](./Q-1777296422940.md)
40. [Scenario: You noticed a sudden increase in latency for your Node.js application hosted on AWS. How would you investigate and resolve this issue?](./Q-1777296475100.md)
41. [How would you implement caching in a Node.js application to improve performance?](./Q-1777296517761.md)
42. [How would you manage environment variables in a Node.js application?](./Q-1777296618988.md)
43. [How would you handle rate limiting in a Node.js API?](./Q-1777296664809.md)
44. [What are worker threads in Node.js, and when would you use them?](./Q-1777296713103.md)
45. [What is clustering in Node.js and when should it be used?](./Q-1777296825038.md)
46. [What is the difference between cluster and worker_threads in Node.js?](./Q-1778571871700.md)
47. [How does Node.js handle memory management and garbage collection?](./Q-1777296760934.md)
48. [What is the Microservices Architecture, and how can we use Node.js to build it?](./Q-1777296872515.md)
49. [What are the best practices for optimizing the performance of a Node.js application?](./Q-1777296920432.md)
50. [How do you prevent memory leaks in a Node.js application?](./Q-1777296961824.md)
51. [How would you implement logging in a Node.js application?](./Q-1777296985334.md)
52. [SIGINT, SIGTERM, SIGKILL - What are these signals?](./Q-1774187357682.md)
53. [What will be the output of the following code](./Q-1777904455906.md)
54. [Authentication in Node.js](./Q-1778480759090.md)
55. [How do you design an observability stack in AWS for a large microservices system](./Q-1778480798716.md)



As per my knowledge,  
Modules are singleton in Node.js.  
Modules are loaded, executed and cached, that way they are singleton.  
So even if we load it multiple times using either require() or import, technically it is loaded once and then subsequent require() or import will get it from cache.
