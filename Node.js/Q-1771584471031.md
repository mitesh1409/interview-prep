...
3. **PATCH** version when you make backward compatible bug/security fixes

Reference: [Semantic Versioning](https://semver.org/)  

**Sementic Versioning Calculator**  
Use the [npm semver calculator](https://semver.npmjs.com/) to check which versions  
a given range operator will match:

Semantic Versioning Range Operators  

`>`  (greater than)           —  any version strictly above specified  
`>=` (greater than or equal)  —  any version at or above specified  
