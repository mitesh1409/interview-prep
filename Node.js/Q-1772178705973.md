...
| Transform | Read + Write (data modified) | `zlib.createGzip()`, `zlib.createGunzip()`, `crypto.createCipheriv()`, custom data transformation pipelines | Compression, encryption, parsing |
